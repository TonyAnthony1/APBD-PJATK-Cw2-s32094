...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie01_StudenciZWarszawy()
    {
        ...
        return DaneUczelni.Studenci.Where(student => student.Miasto == "Warsaw").Select(student => $"{student.NumerIndeksu} {student.Imie} {student.Nazwisko} {student.Miasto}");
    ...
    {
        var rezultat = DaneUczelni.Zapisy.Any(z => !z.CzyAktywny);
        yield return $"Czy istnieje nieaktywny zapis:  {(rezultat ? "Tak" : "Nie")}";
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        ...
        var rezultat = DaneUczelni.Zapisy.Count(zapis => zapis.CzyAktywny);
        yield return $"Ilość aktywnych zapisów w systemie: {rezultat}";
    ...
    {
        return DaneUczelni.Studenci.Select(student => student.Miasto).Distinct().OrderBy(miasto => miasto);
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci.
            ...
            .Select(g => $"{g.Key} | Najwyższa ocena: {g.Max(x => x.OcenaKoncowa):F1}");
    }
